...
export default function Nav() {
  ...
  return (
    <nav style={{
      ...
      {isAdmin && <Link href="/admin/learning-paths" style={adminLinkStyle}>Admin</Link>}
...
const adminLinkStyle: React.CSSProperties = { color: '#fbbf24', textDecoration: 'none', fontSize: 14 }
